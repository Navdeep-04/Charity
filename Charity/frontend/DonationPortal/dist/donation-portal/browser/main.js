...
var AsyncAnimationRendererFactory = class _AsyncAnimationRendererFactory {
   ...
   */
  loadImpl() {
    const loadFn = () => this.moduleImpl ?? import("./chunk-P4ASBJP2.js").then((m) => m);
...
var routes = [
  ...
  // Public routes
  { path: "home", loadComponent: () => import("./chunk-EAWJKGMV.js").then((m) => m.HomeComponent) },
  { path: "login", loadComponent: () => import("./chunk-P3FHCLYT.js").then((m) => m.LoginComponent) },
  { path: "signup", loadComponent: () => import("./chunk-7GADE6GG.js").then((m) => m.SignupComponent) },
  { path: "forgot-password", loadComponent: () => import("./chunk-SUXHS25G.js").then((m) => m.ForgotPasswordComponent) },
  // Protected routes - require authentication
  { path: "donations", canActivate: [authGuard], loadComponent: () => import("./chunk-PODMUXUW.js").then((m) => m.DonationListComponent) },
  { path: "donations/:id", canActivate: [authGuard], loadComponent: () => import("./chunk-KIVZK2IY.js").then((m) => m.DonationDetailsComponent) },
  // Donor-only routes
  { path: "contribute/:id", canActivate: [authGuard, donorGuard], loadComponent: () => import("./chunk-WIMSKHZR.js").then((m) => m.ContributionComponent) },
  { path: "history", canActivate: [authGuard, donorGuard], loadComponent: () => import("./chunk-RAKHUL7O.js").then((m) => m.HistoryComponent) },
  // NGO-only routes
  { path: "ngo/dashboard", canActivate: [authGuard, ngoGuard], loadComponent: () => import("./chunk-PAKNMWO7.js").then((m) => m.NgoDashboardComponent) },
  { path: "ngo/create-donation", canActivate: [authGuard, ngoGuard], loadComponent: () => import("./chunk-2IGIAEYT.js").then((m) => m.CreateDonationComponent) },
  { path: "ngo/edit-donation/:id", canActivate: [authGuard, ngoGuard], loadComponent: () => import("./chunk-2IGIAEYT.js").then((m) => m.CreateDonationComponent) },
  // Admin routes
  { path: "admin/dashboard", canActivate: [authGuard, adminGuard], loadComponent: () => import("./chunk-VAM76WKQ.js").then((m) => m.AdminDashboardComponent) },
  // Fallback
